const Card = ({ children, otherClasses, positionClasses }) => {
    return (
        <div
            className={`relative overflow-hidden rounded-2xl p-[1px] focus:outline-none ${positionClasses} group`}
        >
            ...
            <div
                className={`h-full w-full rounded-2xl bg-slate-950 border border-gray-700 px-7 text-sm font-medium text-white backdrop-blur-3xl gap-2 ${otherClasses}`}
            >
                {children}
            </div>
        </div>
