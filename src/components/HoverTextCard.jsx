const HoverTextCard = ({ stepText, hoverHeading, hoverText, otherClasses }) => {
    return (
        <div
            className={`relative overflow-hidden rounded-xl text-white text-center cursor-pointer group transition-all duration-300 lg:w-[19vw] min-w-72 max-w-[30rem] w-[70vw] py-44 lg:py-60 ${otherClasses}`}
        >
            ...
            <div className="absolute inset-[1px] bg-gray-950 hover:bg-gray-900 rounded-xl border border-gray-700 flex flex-col items-center justify-center transition-all duration-300">
                ...
                <span className="absolute inset-0 text-center flex flex-col items-center justify-center text-lg font-medium opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-y-16 group-hover:translate-y-0 group-hover:scale-100 px-10">
